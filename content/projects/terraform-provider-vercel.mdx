...
date: "2021-03-16"
repository: davisuga/terraform-provider-vercel
url: https://registry.terraform.io/providers/davisuga/vercel/latest
published: true
---
...
terraform {
  required_providers {
    vercel = {
      source  = "registry.terraform.io/davisuga/vercel"
      version = ">=0.10.3"
    }
  }
}
...
resource "vercel_project" "my_project" {
  ...
  git_repository {
    type = "github"
    repo = "davisuga/terraform-provider-vercel"
  }
}
```
